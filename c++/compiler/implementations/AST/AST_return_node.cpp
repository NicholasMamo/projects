...
#include "../../headers/AST/AST_return_node.h"

/**
 * Initialize the node with the given level
 * level            the level of the node
 */
AST_return_node::AST_return_node(unsigned level) : AST_statement_node(level) {
    this->level = level;
}
 ...
 * Delete the node
 */
AST_return_node::~AST_return_node() {
 ...
 */
void AST_return_node::set_expression(AST_node * expression_node) {
 ...
 */
AST_node * AST_return_node::get_expression() {
 ...
 */
void AST_return_node::accept(visitor * v) {
    v->visit(this);
}
 ...
 */
void AST_return_node::set_level(unsigned level) {
    this->level = level;
